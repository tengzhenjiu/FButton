	...
	private LayerDrawable createDrawable(int radius, int topColor, int bottomColor) {
		...
		if (isShadowEnabled && topColor != Color.TRANSPARENT) {
			...
			layerDrawable.setLayerInset(0, 0, 0, 0,
					0); /* index, left, top, right, bottom */
		} else {
			// pressed drawable
			layerDrawable.setLayerInset(0, 0, mShadowHeight, 0,
					0); /* index, left, top, right, bottom */
		}
		layerDrawable.setLayerInset(1, 0, 0, 0,
				mShadowHeight); /* index, left, top, right, bottom */
